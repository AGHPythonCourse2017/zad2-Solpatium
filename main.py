...
def run():
    ...
    parser.add_argument(
        'data',
        help='Must contain a dictionary data_structure (size: problem)')
    parser.add_argument(
        'test',
        help='Must contain a function tested_function, or a class with it')
    parser.add_argument(
        'clean',
        help='Must contain a function clean_function')
    parser.add_argument(
        '-t',
        '--timeout',
        type=int,
